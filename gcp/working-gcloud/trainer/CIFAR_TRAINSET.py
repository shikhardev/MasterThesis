...
if DEBUG:
    from gcloud_skd.trainer.CIFAR_MODEL import Net as Net
    import utils
else:
    import trainer.util as utils
    # import trainer.local_utils as utils
...
class CifarTrainsetWorker(Worker):
    def __init__(self, **kwargs):
        ...
        self.trainset, self.valset = torch.utils.data.random_split(self.trainset, [40000, 10000])
...
if __name__ == '__main__':
    worker = CifarTrainsetWorker(run_id='0')
